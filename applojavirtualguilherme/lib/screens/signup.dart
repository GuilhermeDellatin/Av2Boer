                  ...
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      validator: (cpf) {
                        ...
                        if(cpf.isEmpty)
                          return 'Campo obrigatório';
                        else if (!CPFValidator.isValid("395.180.848-90", true))
                          return 'CPF invalido';
                        return null;
                      },
                    ...
                    TextFormField(
                      ...
                      validator: (cidade) {
                        ...
                        if(cidade.isEmpty)
                          ...
                          return 'Preencha sua Cidade completa';
                        return null;
                      },
                      onSaved: (cidade) => user.cidade = cidade,
                    ),
                    ...
                    TextFormField(
                      decoration:
                      const InputDecoration(hintText: 'Sigla Estado'),
                      enabled: !userManager.loading,
                      validator: (siglaEstado) {
                        //if (cpf.isEmpty)
                        if(siglaEstado.isEmpty)
                          return 'Campo obrigatório';
                        else if (siglaEstado.length < 2)
                          return 'Preencha a sigla do seu estado';
                        return null;
                      },
                      onSaved: (siglaEstado) => user.siglaEstado = siglaEstado,
                    ),
